/*
 * From Improved Stations by shedaniel.
 * Licensed under the MIT.
 */
package com.halotroop.tconstruct.client.screen.container;
...
public class CraftingStationContainer extends Container {
	...
	public boolean canUse(PlayerEntity player) {
		return this.context.run(
				(world, blockPos) -> world.getBlockState(blockPos).getBlock() instanceof CraftingStationBlock
						&& player.squaredDistanceTo(blockPos.getX() + .5D, blockPos.getY() + .5D,
						blockPos.getZ() + .5D) < 64D, true);
	}
